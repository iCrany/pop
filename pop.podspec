Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => 'https://github.com/iCrany/pop.git', :tag => '1.0.9' }
  ...
  spec.vendored_frameworks = "Carthage/Build/iOS/pop.framework"
  spec.prepare_command = "/usr/bin/ruby build_framework.rb"
end
